 ...
 *     This lets git hooks pass the staged files only.
 *   - With no arguments                     -> discover every tracked `.bpmn` under
 *     the ROOTS below, excluding build output and dependencies.
 *
 * CLI usage:
